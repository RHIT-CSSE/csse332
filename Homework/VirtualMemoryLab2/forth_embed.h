...
// Adds a value onto a paused forth stack. Note that this inserts a
// value not at the true top, but below some bookkeeping used by the
// pause mechanism.  Practually speaking though, when forth resumes
// the push value will appear to be at the top.
